...
Test the harv sync operation with dry-run mode and verbose logging to preview what would happen without making actual changes.
...
4. If there's a running binary installed, also show how to test with: `harv sync --dry-run -v`
